...
* 在线编辑: [https://windrunnermax.github.io/DocEditor](https://github.com)
* 开源地址: [https://github.com/WindrunnerMax/DocEditor](https://github.com)


关于`slate`文档编辑器项目的相关文章:


* [基于Slate构建文档编辑器](https://github.com)
* [Slate文档编辑器\-WrapNode数据结构与操作变换](https://github.com):[豆荚加速器](https://yirou.org)
* [Slate文档编辑器\-TS类型扩展与节点类型检查](https://github.com)
* [Slate文档编辑器\-Decorator装饰器渲染调度](https://github.com)
* [Slate文档编辑器\-Node节点与Path路径映射](https://github.com)
...
```
CopyunwrapNodes(editor, { match: (_, p) => Path.equals(p, [3, 1, 0]), at: [3, 1, 0] }); // A
...
```
Copyconst el = document.querySelector(`[data-slate-editor="true"]`);
